...
int Communicator::SendFileSharedInfo( CString *cstrFileSize, CString *cstrPort, CString *cstrFileName )
{
	TCHAR *arrStr[] = {MessProcessor::MC_SHARED_FILEINFO, cstrFileSize->GetBuffer(), cstrPort->GetBuffer(), cstrFileName->GetBuffer()};
